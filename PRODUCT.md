...
Real and citable: the shipped application itself; `docs/printer-calibration-user-guide.md` and `docs/printer-calibration-admin-guide.md`; `docs/ARCHITECTURE.md`; `docs/security/THREAT_MODEL.md`; `docs/release-validation.md`, which records the packaged Windows/macOS release matrix, WebGL2 capability reporting, SwiftShader fallback, and the accessibility gate; and `assets/calibration-asset-manifest.json`.
