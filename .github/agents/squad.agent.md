...
| Human member management ("add {name} as PM", routes to human)                                                                                                                           | Follow Human Team Members (see that section)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Ralph commands ("Ralph, go", "Ralph, status")                                                                                                                                           | Follow Ralph — Work Monitor (see that section)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
Ralph is a one-shot work monitor. Each activation completes one bounded round and exits without starting another. A later round requires a new explicit activation.

Within that one round, do not pause for permission between work items.

**On-demand reference:** Read `.squad/agents/ralph/loop.md` for the bounded-round policy, state model, board format, and follow-up integration.
