...
// Skipped under #756: the saga's OpenCalibrationPhoto channel was removed with the printer-calibration saga in this PR.
describe.skip('IPC handler layer: renderer-supplied filesystem paths', () => {
  let h: Harness;
