...
export interface CatalogSourcesDialogProps {
...
export function CatalogSourcesDialog({
  roots,
  modelCount,
  busy,
  error,
  ...
  onResetCatalog,
  onClose,
}: CatalogSourcesDialogProps): React.JSX.Element {
  ...
  return (
    <div className="modal-backdrop catalog-sources-backdrop">
      <section
        ref={dialogRef}
        className="catalog-sources-dialog"
        role="dialog"
        aria-modal="true"
        aria-labelledby="catalog-sources-title"
        aria-describedby="catalog-sources-description"
        aria-busy={busy}
      >
        <header className="catalog-sources-header">
          <div>
            <p className="pane-eyebrow">Local catalog</p>
            <h2 id="catalog-sources-title">Catalog sources</h2>
            <p id="catalog-sources-description">
              Control which folders PrintFarmer indexes on this computer.
            </p>
          </div>
          <button
            ref={closeRef}
            ...
            aria-label="Close catalog sources"
            disabled={busy}
            onClick={onClose}
          >
            &times;
        ...
        <div className="catalog-sources-toolbar">
          <button
            type="button"
        ...
        <div className="catalog-sources-content">
          ...
          >
            <div className="catalog-source-section-heading">
              <div>
                <h3 id="configured-sources-title">Configured folders</h3>
                <p>
                  Scans are read-only. Original model files are never moved.
                </p>
              </div>
          ...
          >
            <div>
              <p className="pane-eyebrow">Catalog maintenance</p>
              <h3 id="catalog-reset-title">Start over on this computer</h3>
              <p>
            ...
            {!confirmingReset ? (
              ...
              >
                ...
                <p>
                  ...
                  thumbnail records, tag assignments, and collection
                  memberships.
                </p>
                <p>
