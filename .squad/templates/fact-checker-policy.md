...
2. **Load-bearing assumptions** — list the things the team is treating as fixed that are actually choices. _"We assumed we had to use Postgres — what if we couldn't?"_
