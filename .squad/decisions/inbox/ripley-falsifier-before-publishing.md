...
**Why:** the cost of skipping the exercise is not a missed finding. It is a **published conclusion that is backwards**, carrying the author's confidence and, in a ruling context, the author's standing. It can be paid by the person who wrote the rule being violated — I had been warned about this exact failure one comment earlier and posted anyway.
