...
**3. Prove a cap still admits the legitimate maximum.** Reviewing #68's 20,000-row part-tree budget, the check that carried weight was rendering a legitimate 5,001-object scene (at the sidecar's documented 5,000 mesh-object ceiling) and showing it produced 5,001 rows with no truncation. That is what distinguishes a cap from blanket denial, and it is not visible from reading the constant.
